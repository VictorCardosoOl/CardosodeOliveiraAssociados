...
export function SocialResponsibility() {
  ...
  return (
    <section id="responsabilidade-social" className="min-h-screen flex items-center py-24 2xl:py-48 3xl:py-64 bg-secondary text-primary overflow-hidden">
      <div className="container" ref={containerRef}>
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-24 gap-8">
          <div className="max-w-3xl 3xl:max-w-4xl">
            <h2 className="text-accent uppercase tracking-[0.2em] text-sm font-bold mb-4">Responsabilidade Social</h2>
            <h3 className="font-serif text-5xl md:text-6xl lg:text-7xl 3xl:text-8xl leading-[0.9] tracking-tighter font-medium">
        ...
        <div className="grid md:grid-cols-3 gap-8 3xl:gap-12">
          {initiatives.map((item, index) => (
            ...
            >
              <item.icon className="w-12 h-12 text-accent mb-8 group-hover:scale-110 transition-transform duration-500" strokeWidth={1} />
              <h4 className="font-serif text-3xl mb-4 font-medium">{item.title}</h4>
