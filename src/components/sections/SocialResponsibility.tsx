      ...
      <div className="container" ref={containerRef}>
        ...
        <div className="grid md:grid-cols-3 gap-8 3xl:gap-12">
          {initiatives.map((item, index) => (
            <div 
              key={index} 
              className="initiative-card group p-10 bg-muted border border-primary/5 hover:border-accent/30 transition-all duration-500 hover:-translate-y-2 rounded-sm"
            >
