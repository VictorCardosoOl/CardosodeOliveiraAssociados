      ...
      <div className="container grid lg:grid-cols-2 gap-[var(--spacing-gap)] items-center">
        <div className="max-w-2xl 3xl:max-w-4xl">
          ...
          <div className="space-y-12 3xl:space-y-20">
            ...
            <div className="contact-item mt-12 3xl:mt-16 w-full h-64 md:h-80 3xl:h-[500px] relative z-0 border border-secondary/10 rounded-[3rem] rounded-tr-3xl overflow-hidden">
        ...
        <div className="contact-form bg-secondary p-8 md:p-12 lg:p-16 3xl:p-24 4xl:p-32 rounded-[3rem] rounded-tl-3xl border-t-4 border-accent">
