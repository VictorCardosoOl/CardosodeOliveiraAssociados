      ...
      <div className="container">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 3xl:gap-32 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 flex flex-col h-full">
            <div className="mb-12">
              <h2 className="anim-title anim-fade-up font-sans text-xs md:text-sm font-semibold uppercase tracking-[0.2em] text-accent mb-6 flex items-center gap-4">
                <span className="w-8 h-[1px] bg-accent"></span>
                O Escritório
              </h2>
              
              <h3 className="anim-fade-up font-serif text-4xl md:text-5xl lg:text-6xl 3xl:text-7xl 4xl:text-8xl text-primary leading-[1.1] tracking-tighter font-light mb-8">
                Uma advocacia <span className="italic text-accent">feminina</span> e moderna, focada em atendimento exclusivo.
              </h3>
              
              <p className="anim-fade-up text-base md:text-lg 3xl:text-xl text-primary/70 leading-relaxed font-light mb-10 max-w-xl">
              ...
              <a 
                href="#contato"
                className="anim-fade-up inline-flex items-center justify-center gap-2 bg-primary text-secondary px-8 py-4 rounded-full font-medium text-xs tracking-[0.15em] uppercase hover:bg-accent hover:text-primary transition-all duration-300 w-fit"
              >
          ...
          <div className="lg:col-span-7 mt-16 lg:mt-0">
            <div className="anim-image-wrapper relative w-full aspect-[4/5] md:aspect-[3/4] lg:aspect-[4/5] mb-24 overflow-hidden rounded-sm shadow-2xl">
              <img 
            ...
            <div className="pl-0 md:pl-12 lg:pl-24">
              <h4 className="anim-fade-up font-sans text-xs font-semibold uppercase tracking-[0.2em] text-primary mb-12 flex items-center gap-4">
                Como Trabalhamos
              ...
              <div className="flex flex-col">
                {[
                  ...
                  <div key={i} className="anim-fade-up group flex flex-col sm:flex-row sm:items-start gap-6 sm:gap-12 py-10 border-b border-primary/10 hover:bg-primary/5 transition-colors px-6 -mx-6 rounded-lg">
