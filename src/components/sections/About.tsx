      ...
      <div className="container mx-auto px-6 md:px-12 3xl:px-24 grid lg:grid-cols-12 gap-12 lg:gap-24 3xl:gap-32">
        ...
        <div className="lg:col-span-4 flex flex-col justify-between h-full">
          ...
          <div className="mt-auto">
            ...
            <button className="about-elem bg-primary text-secondary px-8 py-4 text-sm font-bold hover:bg-accent transition-colors rounded-sm">
              Fale Conosco
            </button>
          </div>
        </div>
        ...
        <div className="lg:col-span-8">
          <h2 className="about-elem font-serif text-4xl md:text-5xl lg:text-6xl 3xl:text-7xl text-primary leading-[1.1] mb-16 3xl:mb-24 max-w-3xl 3xl:max-w-5xl tracking-tighter font-bold">
            ...
            <div className="flex flex-col">
              {[
                ...
                <div key={i} className="about-elem group flex flex-col md:flex-row md:items-center gap-4 md:gap-12 py-8 border-t border-gray-200 hover:border-accent transition-colors">
                  ...
                  <h3 className="font-serif text-3xl md:text-5xl tracking-tighter text-primary font-bold group-hover:translate-x-4 transition-transform duration-500">{item.title}</h3>
