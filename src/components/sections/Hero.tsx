...
export function Hero() {
  ...
  useGSAP(() => {
    ...
    // 2. Animação de Entrada Elegante (Fade & Slide Up)
    ...
    // 3. Lei da Profundidade (Parallax Suave)
    ...
    <section ref={containerRef} className="relative min-h-[100svh] flex flex-col bg-secondary overflow-hidden pt-20">
      <div className="flex-1 grid lg:grid-cols-2 w-full">
        ...
        <div className="flex flex-col justify-center items-start text-left px-6 md:px-12 lg:pl-16 2xl:pl-20 3xl:pl-24 4xl:pl-32 lg:pr-16 py-[var(--spacing-section-y)] z-10">
          ...
          <a 
            href="#contato"
            className="hero-elem inline-flex items-center justify-center gap-2 bg-accent text-secondary px-10 py-5 rounded-full font-medium text-sm tracking-widest uppercase hover:bg-accent-dark transition-colors duration-300"
          >
